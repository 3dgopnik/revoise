...
- Главное окно: входное видео, выбор TTS и голоса, запуск рендеринга
- Продвинутые параметры вынесены в диалог «Настройки»
...
- Ритм-якоря, автопунктуация, VAD-паузы (350–450 ms)
...
- По умолчанию: speed 0.98–1.02, pause 350–450 ms
